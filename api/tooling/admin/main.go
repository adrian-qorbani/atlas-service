...
func GenToken() error {
	...
	claims := struct {
		...
		RegisteredClaims: jwt.RegisteredClaims{
			Subject:   "3152420d-c05e-419e-a42a-7e5eb1151cac",
	...
	token.Header["kid"] = "7f7b8993-f2d6-42f9-a0e8-1c2ef16c54cd"

	privateKeyPERM, err := os.ReadFile("zarf/keys/7f7b8993-f2d6-42f9-a0e8-1c2ef16c54cd.pem")
	if err != nil {
		return fmt.Errorf("reading private perm: %w", err)
	}

	privateKey, err := jwt.ParseRSAPrivateKeyFromPEM(privateKeyPERM)
	if err != nil {
		return fmt.Errorf("parsing private perm: %w", err)
	}
